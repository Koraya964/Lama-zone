...
const CreerAnnonce = () => {
  ...
  useEffect(() => {
    categoriesService
      ...
      .catch((err) =>
        console.error("Erreur chargement categories :", err.message),
      );
  }, []);
      ...
      <div className="card p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            />
            {erreurs.titre && (
              <p className="text-red-500 text-xs mt-1">{erreurs.titre}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              />
              {erreurs.prix && (
                <p className="text-red-500 text-xs mt-1">{erreurs.prix}</p>
              )}
            </div>
            <div>
              <label
          ...
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-gray-500 cursor-pointer file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-primary-50 file:text-primary-600 hover:file:bg-primary-100"
            />
            {fichiers.length > 0 && (
